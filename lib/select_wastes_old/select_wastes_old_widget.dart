...
class SelectWastesOldWidget extends StatefulWidget {
  const SelectWastesOldWidget({Key key}) : super(key: key);

  @override
  _SelectWastesOldWidgetState createState() => _SelectWastesOldWidgetState();
}

class _SelectWastesOldWidgetState extends State<SelectWastesOldWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await BookingsRecord.collection.doc().set(bookingsCreateData);
    });
  }
